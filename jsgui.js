...
function Quadratic() {
   ...
   this.init = function(num) {
     if(num == 0){
       $('#user_area').append('<div id="quadratic'+cjack+'" class="function"> <div id="quadratic'+cjack+'header" class="function_header"></div><div class="equation"><input type="number" value="1" id="x^2_coefficient_'+ cjack +'" class="coefficient" oninput="quadArray['+ cjack + '].update('+ cjack +','+num+')" >' + '<p class="pow"> x<sup>2</sup> </p>'
       ...
       $('#user_area').append('<div id="quadratic'+cjack+'" class="function"> <div id="quadratic'+cjack+'header" class="function_header">'
       ...
       $('#user_area').append('<div id="quadratic'+cjack+'" class="function"> <div id="quadratic'+cjack+'header" class="function_header">'
       +'</div><div class="equation"><p class="pow">y = </p><input type="number" value="1" id="a_quad2_'+cjack+'" class="coefficient" oninput="quadArray['+cjack+'].update('+ cjack +','+num+')">'
...
function Cubic() {
   ...
   this.init = function(num) {
     if(num == 0){
       $('#user_area').append('<div id="cubic'+cbjack+'"class="function"><div id="cubic'+cbjack+'header" class="function_header"></div><div id="cubic_equation" class="equation">'
     ...
     $('.function').css('border-radius', '20px')
     $('.function').css('height', '18px');
     $('.function').css('width', '200px');
     $('.function').css('padding', '14px');
     $('.function').css('border-radius', '20px');

     $('.function_header').css('width', '200px');
     $('.function_header').css('height', '18px');
     $('.function_header').css('padding','14px');
     $('.function_header').css('border-radius', '20px');
     $('.function_header').css('position', 'absolute');
